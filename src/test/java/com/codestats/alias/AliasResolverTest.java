...
class AliasResolverTest {
    ...
    void shouldResolveContributorWithAliasConfig() {
        ...
        Map<String, Set<String>> aliasConfig = Map.of(
            "john@company.com", Set.of("john@personal.com", "jdoe@contractor.com")
        );
        ...
        assertThat(identity.allEmails()).containsExactlyInAnyOrder(
            "john@company.com", "john@personal.com", "jdoe@contractor.com"
        );
    ...
    void shouldHandleBirgittaExample() {
        ...
        Map<String, Set<String>> aliasConfig = Map.of(
            "bboeckel@thoughtworks.com", Set.of("birgitta410@users.noreply.github.com")
        );
        ...
        assertThat(identity.allNames()).containsExactlyInAnyOrder(
            "Birgitta B", "Birgitta B.", "Birgitta Boeckeler"
        );
    }
    ...
    void shouldChoosePrimaryEmailByCommitCount() {
        ...
        Map<String, Integer> emailCounts = Map.of(
    ...
    void shouldHandleMultipleContributors() {
        ...
        Map<String, Set<String>> aliasConfig = Map.of(
            "alice@company.com", Set.of("alice@personal.com")
        );
    ...
    void shouldCreateDisplayStringWithAliases() {
        ContributorIdentity identity = ContributorIdentity.builder()
    ...
    void shouldHandleNoAliasConfig() {
        ...
        assertThat(identities).hasSize(2);
        assertThat(identities.keySet()).containsExactlyInAnyOrder("john@company.com", "jane@company.com");
    }

    // Helper method to create test commits
    private GitCommit createCommit(String authorName, String authorEmail) {
        return new GitCommit(
            "hash123", authorName, authorEmail, LocalDateTime.now(),
            "Test commit", List.of(), 10, 5
        );
    }
}