...
class CodeStatsConfigTest {
    ...
    void shouldMergeConfigurations() {
        CodeStatsConfig base = new CodeStatsConfig(
        ...
        CodeStatsConfig override = new CodeStatsConfig(
    ...
    void shouldIncludeComprehensiveDirectoryPatterns() {
        ...
        assertThat(config.productionDirectories()).contains(
            "src", "lib", "app", "source", "main"
        );
        
        // Test patterns should cover various testing frameworks
        assertThat(config.testDirectories()).contains(
            "test", "tests", "__tests__", "spec", "specs", "cypress", "e2e"
        );
    }
}