...
public interface AliasResolver {
  ...
  /**
   * Resolve a list of commits to unified contributor identities. Groups commits by contributor,
   * handling email aliases and name variations.
   *
   ...
   */
  Map<String, ContributorIdentity> resolveIdentities(
      List<GitCommit> commits, Map<String, Set<String>> aliasConfig);

  /**
   * Find the canonical name for a contributor given multiple name variations. Strategy: Choose the
   * longest/most complete name that appears most frequently.
   *
  ...
  /**
   * Find the primary email for a contributor. Strategy: Email with most commits, or first
