...
/**
 * Immutable record representing a unified contributor identity. Handles the case where one person
 * commits using multiple emails/names.
 */
public record ContributorIdentity(
    String canonicalName, String primaryEmail, List<String> allEmails, List<String> allNames) {
