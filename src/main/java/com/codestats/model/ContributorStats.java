...
/**
 * Immutable record representing statistics for a single contributor.
 * Using Java 17 records for immutability and functional style.
 */
    ...
    public static class Builder {
        ...
        public ContributorStats build() {
            return new ContributorStats(
                name, primaryEmail, allEmails, commitCount, filesChanged,
                insertions, deletions, languageStats, productionLines, testLines
            );
        }
    }
}