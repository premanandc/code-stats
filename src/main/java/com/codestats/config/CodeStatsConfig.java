...
/**
 * Immutable configuration record for code statistics analysis.
 * Loaded from YAML files and command-line overrides.
 */
public record CodeStatsConfig(
    ...
    public CodeStatsConfig mergeWith(CodeStatsConfig other) {
        return new CodeStatsConfig(
            ...
            other.productionDirectories.isEmpty() ? this.productionDirectories : other.productionDirectories,
    ...
    private Map<String, String> mergeLanguages(Map<String, String> base, Map<String, String> override) {
    ...
    private Map<String, Set<String>> mergeAliases(Map<String, Set<String>> base, Map<String, Set<String>> override) {
