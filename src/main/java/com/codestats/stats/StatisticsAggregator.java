...
/**
 * Functional interface for aggregating git commit data into contributor statistics.
 * Combines commit data with contributor identities to produce final analytics.
 */
public interface StatisticsAggregator {
     ...
     */
    List<ContributorStats> aggregateStatistics(List<GitCommit> commits,
    ...
    /**
     * Calculate total commit count across all contributors.
     ...
     */
    default boolean isProductionCode(String filePath, 
                                   List<String> productionPatterns, 
                                   List<String> testPatterns) {
